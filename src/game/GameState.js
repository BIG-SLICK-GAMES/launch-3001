...
const allowed = {
  ...
  [STATES.FLYING]: [STATES.PAUSED, STATES.LANDED, STATES.CRASHED, STATES.READY, STATES.MENU, STATES.DEMO_COMPLETE, STATES.LEVEL_COMPLETE, STATES.GAME_COMPLETE],
  ...
  [STATES.CRASHED]: [STATES.READY, STATES.MENU, STATES.LEVEL_SELECT, STATES.LOBBY],
