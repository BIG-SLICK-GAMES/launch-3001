...
const allowed = {
  [STATES.BOOT]: [STATES.SPLASH, STATES.AUTH, STATES.DEVICE_SELECT, STATES.LOBBY, STATES.MENU, STATES.READY],
  [STATES.SPLASH]: [STATES.AUTH, STATES.DEVICE_SELECT, STATES.LOBBY, STATES.READY],
  [STATES.AUTH]: [STATES.DEVICE_SELECT, STATES.LOBBY, STATES.SPLASH],
  [STATES.DEVICE_SELECT]: [STATES.LOBBY, STATES.AUTH],
  [STATES.LOBBY]: [STATES.AUTH, STATES.DEVICE_SELECT, STATES.LEVEL_SELECT, STATES.READY, STATES.MENU],
