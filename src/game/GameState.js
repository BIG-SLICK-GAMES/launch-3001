...
const allowed = {
  [STATES.BOOT]: [STATES.SPLASH, STATES.LOBBY, STATES.MENU, STATES.READY],
  [STATES.SPLASH]: [STATES.LOBBY, STATES.READY],
  [STATES.LOBBY]: [STATES.LEVEL_SELECT, STATES.READY, STATES.MENU],
